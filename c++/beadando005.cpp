...
GLint keyStates[256];
vec2 points[13] = { {50, 100}, {50, 120}, {50, 135}, {80, 135}, {110, 135}, {90, 160}, {110, 200}, {125, 240}, {250, 400}, {400, 350}, {550, 250}, {700,140}, {700,100} };
vec2 decastPoints[5][5];
float u = 0.5;
mat24 hermite={points[0],points[1],points[2],points[3]};
float t[3] = {-2.0,0.5,1.5};
vec4 mvectors[4] = {{pow(t[0],3.0f),pow(t[0],2.0f),t[0],1.0f},{pow(t[1],3.0f),pow(t[1],2.0f),t[1],1.0f},{pow(t[2],3.0f),pow(t[2],2.0f),t[2],1.0f},{3*pow(t[0],2.0f),2*t[0],1.0f,0.0f}};
...
void processMouse(GLint button, GLint action, GLint xMouse, GLint yMouse) {
	...
	if (button == GLUT_LEFT_BUTTON && action == GLUT_DOWN)
		if ((i = getActivePoint(points, 12, 3, xMouse, winHeight - yMouse)) != -1)
			dragged = i;
